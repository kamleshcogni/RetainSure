...
import { CustomerDetalis } from './features/admin/admin-dashboard/customer-detalis/customer-detalis';
...
export const routes: Routes = [
  ...
  {
  path: 'admin/policies/expiring',
  canActivate: [RoleGuard],
  component: AdminPlolicyList,
  data: { policyType: 'Expiring', roles: ['admin'] }
},
{ path: 'admin/customers/:id', component: CustomerDetalis, canActivate: [RoleGuard], data: {roles: ['admin']}},
